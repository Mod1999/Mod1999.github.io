...
<article class="search-result row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		<h4><a href="/page/<? echo $pub->id; ?>" title=""><? echo $pub->title; ?></a><div class="pubcat pull-right">Категория: <? if($pub->cat != 0): ?><a href="<? echo '/page/'.$pub->catslug; ?>"><? echo $pub->catname; ?></a><? else: ?> —<? endif; ?></div></h4>
		<div class="pubbody">
