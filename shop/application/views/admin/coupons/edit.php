...
<table class="table">
	...
	<tr>
		...
		<td><div class="input-group" id="timefrom"><? echo form_input('timefrom', set_value('timefrom', $coupon->timefrom),'class="date form-control"'); ?><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div></td>
	</tr>
	<tr>
		<td>Время действия до:</td>
		<td><div class="input-group" id="timeto"><? echo form_input('timeto', set_value('timeto', $coupon->timeto),'class="form-control"'); ?><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div></td>
	</tr>
	<tr>
		<td>Товар:</td>
