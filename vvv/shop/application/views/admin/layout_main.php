			...
			<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
				<ul class="nav navbar-nav">
					<li><? echo anchor('admin/goods','Товары'); ?></li>
                                                                                          <li><? echo anchor('admin/categories','Категории'); ?></li>
					<li class="dropdown">
					...
					<li><? echo anchor('admin/template','Редактор'); ?></li>
					<li><? echo anchor('admin/coupons','Промо-коды'); ?></li>
					<li><? echo anchor('admin/config','Настройки'); ?></li>
				</ul>
				<ul class="nav navbar-nav pull-right">
					<li><? echo anchor('admin/user/logout','<i class="glyphicon glyphicon-off"></i> Выйти'); ?></li>
				</ul>
			</nav>
		</div>
	</div>
